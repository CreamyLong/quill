...
def _default_tools() -> list[dict[str, Any]]:
    return [
        ...
        {"name": "grep", "use": "quill.sandbox.tools:grep_tool", "group": "file:read"},
        {"name": "write_file", "use": "quill.sandbox.tools:write_file_tool", "group": "file:write"},
        {"name": "str_replace", "use": "quill.sandbox.tools:str_replace_tool", "group": "file:write"},
        {"name": "bash", "use": "quill.sandbox.tools:bash_tool", "group": "bash"},
    ]
...
def _build_tools(
    *,
    ...
    if include_bash_tool:
        tools.append({"name": "bash", "use": "quill.sandbox.tools:bash_tool", "group": "bash"})
...
def build_minimal_config(
    *,
    ...
    sandbox_use: str = "quill.sandbox.local:LocalSandboxProvider",
    ...
    if sandbox_use == "quill.sandbox.local:LocalSandboxProvider":
