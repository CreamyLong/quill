...
LLM_PROVIDERS: list[LLMProvider] = [
    LLMProvider(
        ...
        use="quill.models.patched_deepseek:PatchedChatDeepSeek",
    ...
    LLMProvider(
        ...
        use="quill.models.vllm_provider:VllmChatModel",
    ...
    LLMProvider(
        ...
        use="quill.models.mindie_provider:MindIEChatModel",
...
SEARCH_PROVIDERS: list[SearchProvider] = [
    SearchProvider(
        ...
        use="quill.community.ddg_search.tools:web_search_tool",
        env_var=None,
    ...
    SearchProvider(
        ...
        use="quill.community.infoquest.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="quill.community.exa.tools:web_search_tool",
        env_var="EXA_API_KEY",
        extra_config={
            "max_results": 5,
            "search_type": "auto",
    ...
    SearchProvider(
        ...
        use="quill.community.firecrawl.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="quill.community.fastcrw.tools:web_search_tool",
        env_var="CRW_API_KEY",
        extra_config={"max_results": 5},
    ),
    SearchProvider(
        ...
        use="quill.community.brave.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="quill.community.groundroute.tools:web_search_tool",
...
WEB_FETCH_PROVIDERS: list[WebProvider] = [
    WebProvider(
        ...
        use="quill.community.jina_ai.tools:web_fetch_tool",
        env_var=None,
        tool_name="web_fetch",
    ...
    WebProvider(
        ...
        use="quill.community.exa.tools:web_fetch_tool",
        env_var="EXA_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        display_name="InfoQuest",
        description="API key required",
        use="quill.community.infoquest.tools:web_fetch_tool",
        env_var="INFOQUEST_API_KEY",
        tool_name="web_fetch",
    ...
    WebProvider(
        ...
        use="quill.community.firecrawl.tools:web_fetch_tool",
        env_var="FIRECRAWL_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="quill.community.groundroute.tools:web_fetch_tool",
        env_var="GROUNDROUTE_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="quill.community.fastcrw.tools:web_fetch_tool",
        env_var="CRW_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        use="quill.community.crawl4ai.tools:web_fetch_tool",
        env_var=None,
        tool_name="web_fetch",
