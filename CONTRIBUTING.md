...
Thank you for your interest in contributing to Quill! This guide will help you set up your development environment and understand our development workflow.
...
|---------|-----------|------------|-------|
| `make dev` on one machine | 4 vCPU, 8 GB RAM | 8 vCPU, 16 GB RAM | Best when Quill uses hosted model APIs. |
...
`2 vCPU / 4 GB` environments often fail to start reliably or become unresponsive under normal Quill workloads.
...
```text
unable to get image 'quill-gateway': permission denied while trying to connect to the Docker daemon socket at unix:///var/run/docker.sock
```
...
│   │   └── quill/       # Agents, tools, sandbox, MCP, skills, config
...
Quill is an AI project and we welcome AI-assisted contributions. To help
...
`.quill/support-bundles/`. The zip includes toolchain versions, sanitized
...
- Check existing [Issues](https://github.com/CreamyLong/quill/issues)
- Read the [Documentation](backend/docs/)
- Ask questions in [Discussions](https://github.com/CreamyLong/quill/discussions)

## License

By contributing to Quill, you agree that your contributions will be licensed under the [Apache 2.0 License](./LICENSE).
