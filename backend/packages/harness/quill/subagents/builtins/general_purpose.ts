 ...
 *
 * Mirrors `quill.subagents.builtins.general_purpose` from the Python backend.
 */

import { createSubagentConfig, type SubagentConfig } from "../config.js";

export const GENERAL_PURPOSE_CONFIG: SubagentConfig = createSubagentConfig({
...
`,
  tools: null, // Inherit all tools from parent
  disallowedTools: ["task", "ask_clarification", "present_files"], // Prevent nesting and clarification
  model: "inherit",
  maxTurns: 150,
});
