...
Requirements:
    ...
    resolves quill-harness and app packages correctly:
...
async def main():
    ...
    from quill.config.app_config import apply_logging_level

    app_config = get_app_config()
    apply_logging_level(app_config.log_level)

    # Delay the rest of the quill imports until *after* logging is installed
    # so that any import-time side effects (e.g. quill.agents starts a
    ...
    from quill.config.paths import get_paths
    from quill.mcp import initialize_mcp_tools
    from quill.runtime.user_context import get_effective_user_id
