"""End-to-end demo: SafetyFinishReasonMiddleware on the real Quill lead-agent.

What it proves
--------------
- The real ``make_lead_agent`` / ``QuillClient`` pipeline is built (full
...
def main() -> int:
    ...
    # at import time via ``from quill.models import create_chat_model``,
    ...
    # imported names.
    import quill.agents.lead_agent.agent as lead_agent_module
    import quill.client as client_module
