...
This directory contains detailed documentation for the Quill backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs QuillClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to Quill?** Start with [SETUP.md](SETUP.md) for quick installation
