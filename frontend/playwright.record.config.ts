 ...
 * + QUILL_RECORD_OUT in the environment — never run in CI.
 *
  ...
  webServer: [
    {
      ...
      env: {
        ...
        ...(process.env.QUILL_RECORD_OUT
          ? { QUILL_RECORD_OUT: process.env.QUILL_RECORD_OUT }
          : {}),
    ...
    },
    {
      ...
      env: {
        ...
        QUILL_INTERNAL_GATEWAY_BASE_URL: "http://127.0.0.1:8012",
      },
    },
  ],
});
