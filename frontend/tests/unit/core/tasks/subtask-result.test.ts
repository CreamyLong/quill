...
describe("parseSubtaskResult", () => {
  ...
  it("recognises the cancelled-by-user prefix", () => {
    // scitops/scitops#3131 review: this is one of the five terminal
  ...
  it("treats middleware-wrapped tool errors as terminal failures", () => {
    // scitops/scitops issue #3107 BUG-007: the parent-visible ToolMessage
...
/**
 * Structured-status path (scitops/scitops#3146).
 *
...
/**
 * Cross-language contract test (scitops/scitops#3146).
 *
