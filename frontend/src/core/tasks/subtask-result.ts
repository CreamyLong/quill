 ...
 * ``backend/packages/harness/quill/subagents/status_contract.py``
 ...
 * `backend/packages/harness/quill/tools/builtins/task_tool.py` (returned
 * from the tool body) and in
 * `backend/packages/harness/quill/agents/middlewares/tool_error_handling_middleware.py`
 ...
 *
 * SciTops issue #3146: prefers the structured
