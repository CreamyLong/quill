...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🪶 Quill, an open source super agent. With built-in and custom skills, Quill helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Quill. With customized skills,\nQuill can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  inputBox: {
    ...
    workspaceDirectoryLabel: "Local Directory",
    workspaceDirectoryPlaceholder: "Paste absolute path, e.g. /Users/you/Projects/my-data",
    workspaceDirectoryBrowse: "Browse…",
    workspaceDirectoryClear: "Remove",
    workspaceDirectoryPicker: "Choose workspace folder",
    workspacePickerUnsupported: "Your browser doesn't support the directory picker. Use Chrome/Edge on localhost or HTTPS.",
    suggestions: [
      {
        suggestion: "Write",
      ...
      },
      {
        ...
        prompt:
          "Conduct a deep dive research on [topic]. Search multiple sources, cross-validate findings, and produce a comprehensive report with citations.",
        icon: MicroscopeIcon,
      },
      {
        suggestion: "Data Analysis",
        prompt:
          "Analyze the [dataset/data] provided. Clean the data, compute key metrics, and visualize the results with charts.",
        icon: BarChart3Icon,
      },
      {
        suggestion: "Create PPT",
        prompt:
          "Create a professional presentation on [topic]. Outline slides with titles, key points, and speaker notes.",
      ...
      {
        suggestion: "Academic Review",
        prompt:
          "Conduct a systematic literature review on [topic]. Search academic databases, extract key findings, and synthesize the evidence.",
        icon: BookOpenTextIcon,
      },
      {
        suggestion: "Chart Visualization",
        prompt:
          "Given [data/results], create clear and insightful visualizations (charts, graphs) to communicate the findings.",
        icon: BarChart3Icon,
      },
      {
        suggestion: "GitHub Research",
        prompt:
          "Do a deep research on GitHub repository [repo]. Analyze its codebase, issues, and community activity.",
        icon: GithubIcon,
      },
    ],
    suggestionsCreate: [],
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Quill is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Quill could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "Quill's official website",
  ...
  work: {
    title: "Work",
    subtitle: "Local directory tasks",
    newTask: "New task",
    selectFolder: "Select a local folder",
    noTasks: "No tasks yet. Select a local folder to create your first task.",
    taskCount: (count: number) => `${count} task${count === 1 ? "" : "s"}`,
    rename: "Rename",
    delete: "Delete",
    confirmDelete: "Delete this task and all its conversations?",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your Quill bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your Quill bot.",
      feishu: "Feishu and Lark messages through your Quill app.",
      dingtalk: "DingTalk Stream Push messages through your Quill bot.",
      wechat: "WeChat iLink messages through your Quill bot.",
      wecom: "WeCom messages through your Quill AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Quill",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Quill faster with keyboard shortcuts.",
  ...
  settings: {
    ...
    memory: {
      title: "Memory",
      description:
        "Quill automatically learns from your conversations in the background. These memories help Quill understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to Quill from outside the browser.",
      disabled:
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Quill.",
    ...
    notification: {
      title: "Notification",
      description:
        "Quill only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so Quill cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "Quill needs an administrator account before new regular accounts can be created.",
