...
export interface Translations {
  ...
  inputBox: {
    ...
    workspaceDirectoryPlaceholder: string;
    workspaceDirectoryBrowse: string;
    workspaceDirectoryClear: string;
    workspaceDirectoryPicker: string;
    workspacePickerUnsupported: string;
    suggestions: {
      suggestion: string;
      prompt: string;
      icon: LucideIcon;
