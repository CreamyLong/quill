...
export const PromptInput = ({
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    // Clear input IMMEDIATELY (synchronously) so the user sees it disappear
    // right after pressing Enter — don't wait for the async onSubmit to
    // resolve (which may take seconds for model inference).
    if (usingProvider) {
