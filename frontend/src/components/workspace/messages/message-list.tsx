        ...
        {groupedMessages.map((group, groupIndex) => {
          ...
          if (group.type === "human" || group.type === "assistant") {
            ...
            if (message && hasContent(message)) {
              ...
              const clarificationPayload = parseClarificationContent(rawContent);
              const displayContent = clarificationPayload
                ? formatClarificationPayload(clarificationPayload)
                : stripInternalMarkers(rawContent);
              return (
            ...
            return (
              <div className="w-full" key={group.id}>
                ...
                <ArtifactFileList files={Array.from(files)} threadId={threadId} />
                {renderTokenUsage({
                  messages: group.messages,
                  turnUsageMessages,
                })}
