...
const features: BentoCardProps[] = [
  ...
  },
  {
    ...
    description: "DeepSeek, OpenAI, Gemini, etc.",
  },
  {
    color: COLOR,
    label: "Free",
...
export function WhatsNewSection({ className }: { className?: string }) {
  return (
    <Section
      ...
      title="Whats New in Quill 2.0"
      subtitle="Quill is now evolving from a Deep Research agent into a full-stack Super Agent"
    >
