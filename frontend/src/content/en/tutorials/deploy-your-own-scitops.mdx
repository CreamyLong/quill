---
title: Deploy Your Own SciTops
description: This tutorial guides you through deploying SciTops to a production environment using Docker Compose for multi-user access.
---

import { Callout, Steps } from "nextra/components";

# Deploy Your Own SciTops

This tutorial guides you through deploying SciTops to a production environment using Docker Compose for multi-user access.
...
- Back up `backend/.scitops/` directory regularly
