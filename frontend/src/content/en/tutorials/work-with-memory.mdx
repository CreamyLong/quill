...
description: This tutorial shows you how to enable and use SciTops's memory system so the agent remembers important information about you across multiple sessions.
---
...
This tutorial shows you how to enable and use SciTops's memory system so the agent remembers important information about you across multiple sessions.
...
Memory is stored in `backend/.scitops/memory.json`:

```bash
cat backend/.scitops/memory.json
```
...
```
backend/.scitops/agents/{agent_name}/memory.json
```
...
- [Deploy Your Own SciTops](/docs/tutorials/deploy-your-own-scitops)
