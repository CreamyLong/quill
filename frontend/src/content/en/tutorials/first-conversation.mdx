...
description: This tutorial walks you through your first complete agent conversation in SciTops — from launching the app to getting meaningful work done with the agent.
---
...
This tutorial walks you through your first complete agent conversation in SciTops — from launching the app to getting meaningful work done with the agent.

## Prerequisites

- SciTops app is running (see [Quick Start](/docs/application/quick-start))
...
The agent used the SciTops Harness to:
