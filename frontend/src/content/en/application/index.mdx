---
title: SciTops App
description: SciTops App is the reference implementation of what a production SciTops experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  SciTops App is a complete Super Agent application built on top of SciTops
...
SciTops App is the reference implementation of what a production SciTops experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The SciTops App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, SciTops Harness                               |
| Reverse proxy     | nginx                                                                |
