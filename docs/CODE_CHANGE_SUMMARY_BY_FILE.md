...
### 2. `backend/packages/harness/quill/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/quill/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_quill_20260201.md`

```diff
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "Quill GitHub Repository", "url": "https://github.com/scitops/scitops", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
