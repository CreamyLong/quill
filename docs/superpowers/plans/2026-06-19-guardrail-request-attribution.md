...
| Modify | `backend/packages/harness/quill/guardrails/provider.py` | `GuardrailRequest` 扩字段 |
| Modify | `backend/packages/harness/quill/guardrails/middleware.py` | 从 runtime context 填充字段 |
...
**Files:**
- Modify: `backend/packages/harness/quill/guardrails/provider.py`
...
**Files:**
- Modify: `backend/packages/harness/quill/guardrails/middleware.py`
