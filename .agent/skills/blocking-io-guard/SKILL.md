...
- Your change touches Python under `backend/app/`,
  `backend/packages/harness/scitops/`, or `backend/scripts/` and may run on
...
`.scitops/blocking-io-findings.json`. Work HIGH priority first; do not start
